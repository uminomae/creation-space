...
source_archive: "evidence/archive/pre-rerun-20260407/evidence/evidence-D16-history.md"
original_access_status: not-yet-reviewed
---

# 論拠DB：歴史学（History）（再監査待ち）
...
- source manifest には D16 first batch 10件を反映済み
...
- blocked-access:
  `Toynbee (1934-1961)` は Internet Archive download route が redirect 後に item unavailable / 401 へ着地し raw 未取得。manual/browser 再試行余地あり
  `Braudel (1958)` は Persée PDF route が HTTP 403 HTML に着地し raw 未取得。manual/browser 再試行余地あり
...
- スナップショット: [`evidence/archive/pre-rerun-20260407/evidence/evidence-D16-history.md`](archive/pre-rerun-20260407/evidence/evidence-D16-history.md)
- 退避日: 2026-04-07
