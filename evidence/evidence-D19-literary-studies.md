...
source_archive: "evidence/archive/pre-rerun-20260407/evidence/evidence-D19-literary-studies.md"
original_access_status: not-yet-reviewed
---

# 論拠DB：文学・文芸学（Literary Studies）（再監査待ち）
...
- blocked-access:
  `Bourdieu (1971)` は Persée PDF route が HTTP 403 HTML に着地し raw 未取得。manual/browser 再試行余地あり
...
- スナップショット: [`evidence/archive/pre-rerun-20260407/evidence/evidence-D19-literary-studies.md`](archive/pre-rerun-20260407/evidence/evidence-D19-literary-studies.md)
- 退避日: 2026-04-07
