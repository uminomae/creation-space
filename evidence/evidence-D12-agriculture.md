...
source_archive: "evidence/archive/pre-rerun-20260407/evidence/evidence-D12-agriculture.md"
original_access_status: not-yet-reviewed
---

# 論拠DB：農学・生態学（Agriculture & Ecology）— Step 7（再監査待ち）
...
- D12 の残る citation-only source で official full-text route の有無を順送りで切り分ける
- 行政・研究機関文書を優先して second pass を継続する
