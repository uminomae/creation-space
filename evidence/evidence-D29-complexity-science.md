...
source_archive: "evidence/archive/pre-rerun-20260407/evidence/evidence-D29-complexity-science.md"
original_access_status: not-yet-reviewed
---

# 論拠DB：複雑系科学（Complexity Science）（再監査待ち）
...
- D29 の残る citation-only source で official full-text route の有無を順送りで切り分ける
- Nobel / Springer / journal official route の second pass を継続する
