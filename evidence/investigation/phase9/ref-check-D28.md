# D28 舞台芸術・パフォーマンス — Phase 9 原典検証（再監査待ち）
...
- source manifest には D28 first/second batch 10件を反映済み
...
- raw-confirmed:
  `世阿弥古典集` は Wikimedia Commons / NDL scan の PDF を取得済み
- blocked-access:
  0件
- citation-only:
...
- スナップショット: [`evidence/archive/pre-rerun-20260407/phase9/ref-check-D28.md`](../../archive/pre-rerun-20260407/phase9/ref-check-D28.md)
- 退避日: 2026-04-07
