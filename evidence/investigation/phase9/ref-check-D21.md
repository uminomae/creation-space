# Phase 9-1 原典検証: D21 経済学 (Economics)（再監査待ち）
...
- source manifest には D21 first batch 10件を反映済み
...
- raw-confirmed:
  `knowledge/raw/D21_schumpeter_1912_theorie-der-wirtschaftlichen-entwicklung.pdf`
  `knowledge/raw/D21_schumpeter_1939_business-cycles.pdf`
  ...
  `knowledge/raw/D21_knight_1921_risk-uncertainty-profit.pdf`
...
- スナップショット: [`evidence/archive/pre-rerun-20260407/phase9/ref-check-D21.md`](../../archive/pre-rerun-20260407/phase9/ref-check-D21.md)
- 退避日: 2026-04-07
