# Phase 9-1 原典検証: D12 農学・生態学 (Agriculture & Ecology)（再監査待ち）
...
- raw-confirmed:
  ...
  `knowledge/raw/D12_stern_1959_integrated-control-concept.pdf`
- blocked-access:
  `Clements (1916)` は Internet Archive download route が 503/HTML error page を返し raw 未取得
...
- スナップショット: [`evidence/archive/pre-rerun-20260407/phase9/ref-check-D12.md`](../../archive/pre-rerun-20260407/phase9/ref-check-D12.md)
- 退避日: 2026-04-07
