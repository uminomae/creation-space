# Phase 9-1 原典検証: D16 歴史学 (History)（再監査待ち）
...
- blocked-access:
  `Toynbee (1934-1961)` は Internet Archive download route が redirect 後に item unavailable / 401 へ着地し raw 未取得
  `Braudel (1958)` は Persée PDF route が HTTP 403 HTML に着地し raw 未取得
...
- スナップショット: [`evidence/archive/pre-rerun-20260407/phase9/ref-check-D16.md`](../../archive/pre-rerun-20260407/phase9/ref-check-D16.md)
- 退避日: 2026-04-07
