...
- `output.md`: 15件の再読、GPT成果品とのギャップ、発見と仮説、保持論点を収録

## 要点

- 強い対応は「5段階の数合わせ」ではなく、`縁→渦` の生成機構が理論内部で具体的に記述されているかどうかで決まる。
- 発達心理学で最も厚いのは `縁` であり、ZPD、共同注意、情動調律を並べると、縁は二者接触より三項的・媒介的な界面として見えてくる。
- `束` は個人内の安定より、内的作業モデル、skill web、言語、規範のように別場面へ残る構造として読む方が精度が高い。
