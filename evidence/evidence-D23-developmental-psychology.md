...
source_archive: "evidence/archive/pre-rerun-20260407/evidence/evidence-D23-developmental-psychology.md"
original_access_status: not-yet-reviewed
---

# 論拠DB：発達心理学（Developmental Psychology）（再監査待ち）
...
- raw-confirmed:
  ...
  `木下孝司 (2001)` は Kobe University repository PDF を `knowledge/raw/` に格納した
  `Kegan (1982)` は Internet Archive open item を `knowledge/raw/` に格納した
- blocked-access:
  0件
- citation-only:
