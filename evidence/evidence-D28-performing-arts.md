...
source_archive: "evidence/archive/pre-rerun-20260407/evidence/evidence-D28-performing-arts.md"
original_access_status: not-yet-reviewed
---

# 論拠DB：舞台芸術・パフォーマンス（Performing Arts）（再監査待ち）
...
- source manifest には D28 first batch 10件を反映済み
...
- スナップショット: [`evidence/archive/pre-rerun-20260407/evidence/evidence-D28-performing-arts.md`](archive/pre-rerun-20260407/evidence/evidence-D28-performing-arts.md)
- 退避日: 2026-04-07
