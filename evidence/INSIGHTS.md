...
**更新日**: 2026-03-10
**目的**: deepdive・P1横断洞察の参照起点。新セッション開始時や deepdive 完了後に更新する。

## P1 横断洞察（しっくり感チェック）

→ [review/p1-cross-domain-insights.md](review/p1-cross-domain-insights.md)

## Deepdive 洞察

| 領域 | エージェント | セッション | ファイル | 一言要約 |
|---|---|---|---|---|
...
| D22 経営学 | codex-parallel | insight1 | [deepdive/codex-parallel-deepdive/D22-business-management/insight1/output.md](deepdive/codex-parallel-deepdive/D22-business-management/insight1/output.md) | D3制度化・場は設計対象（仮説1〜4）。D22の不足5系統が「組織の抱持喪失」に収束する可能性 |
...
- deepdive の output.md が生成されるたびに本ファイルに1行追記する
- 一言要約は output.md の「統合結論」または「§C」から抜粋する
- 追記は CLI が担当（deepdive 指示書に追記タスクを含める）
