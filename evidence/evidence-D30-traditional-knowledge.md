...
source_archive: "evidence/archive/pre-rerun-20260407/evidence/evidence-D30-traditional-knowledge.md"
original_access_status: not-yet-reviewed
---

# 論拠DB：伝統知・技芸（Traditional Knowledge）（再監査待ち）
...
- D30 の残る citation-only source で official full-text route の有無を順送りで切り分ける
- institutional/public guidance を優先して second pass を継続する
