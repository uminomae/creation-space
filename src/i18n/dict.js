export const dict = {
    ja: {
        page: {
            ...
            reportsOpenStatus: '調査内容',
            reportsLevelLegend: '進捗分類を読み込み中...',
            reportsLoading: '読み込み中...',
            reportsPhase8Description: '30領域を横断して抽出された5つの構造テーマ。',
            reportsThemeVerificationDescription: 'Phase 9 の検証結果に基づく5テーマの堅牢性評価。',
    ...
    en: {
        page: {
            ...
            crossAnalysisHeading: 'CROSS ANALYSIS',
            reportsOpenStatus: 'Investigation Notes',
            reportsLevelLegend: 'Loading progress categories...',
            reportsLoading: 'Loading...',
            reportsPhase8Description: 'Five structural themes extracted across 30 domains.',
            reportsThemeVerificationDescription: 'Robustness assessment of five structural themes based on Phase 9 verification results.',
