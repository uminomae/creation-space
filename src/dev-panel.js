...
const PARAM_GROUPS = [
    ...
    },
    {
        ...
        fields: [
            ...
            ['refractMix', 'Refract Mix', 0.0, 1.0, 0.01],
            ['transparency', 'Transparency', 0.0, 1.0, 0.01],
            ['specular', 'Specular', 0.0, 1.0, 0.01],
            ['specularPower', 'Specular Power', 1.0, 64.0, 0.5],
            ['fresnel', 'Fresnel', 0.0, 1.0, 0.01],
